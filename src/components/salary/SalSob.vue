      ...
      <el-main style="padding-left: 0px;padding-top: 0px">
        <div>
          ...
          >
            ...
            <el-table-column prop="name" label="账套名称" align="center" width="150"></el-table-column>
            <el-table-column prop="basicSalary" label="基本工资" align="center" width="80"></el-table-column>
            <el-table-column prop="trafficSalary" label="交通补助" align="center" width="80"></el-table-column>
            <el-table-column prop="lunchSalary" label="午餐补助" align="center" width="80"></el-table-column>
            <el-table-column prop="bonus" label="奖金" align="center" width="80"></el-table-column>
            <el-table-column label="创建时间" align="center" width="120">
              <template slot-scope="scope">{{ scope.row.createDate | formatDate}}</template>
            </el-table-column>
            <el-table-column label="养老金" align="center">
              <el-table-column prop="pensionPer" label="比率" align="center" width="65"></el-table-column>
              <el-table-column prop="pensionBase" label="基数" align="center" width="65"></el-table-column>
            </el-table-column>
            <el-table-column label="医疗保险" align="center">
              <el-table-column prop="medicalPer" label="比率" align="center" width="65"></el-table-column>
              <el-table-column prop="medicalBase" label="基数" align="center" width="65"></el-table-column>
            </el-table-column>
            <el-table-column label="公积金" align="center">
              <el-table-column prop="accumulationFundPer" label="比率" align="center" width="65"></el-table-column>
              <el-table-column prop="accumulationFundBase" label="基数" align="center" width="65"></el-table-column>
            </el-table-column>
            <el-table-column prop="allSalary" label="账套总薪资" align="center" width="80"></el-table-column>
...
export default {
  ...
  methods: {
    deleteAll() {
      this.$confirm(
        "删除[" + this.multipleSelection.length + "]条记录, 是否继续?",
        "提示",
        {
          ...
          if (this.salary.id) {
            ...
            this.$prompt("请输入账套名称", "提示", {
              ...
              .then(({ value }) => {
                ...
                this.postRequest("/salary/sob/salary", this.salary).then(
                  resp => {
                    if (resp && resp.status == 200) {
                      var data = resp.data;
                      _this.dialogVisible = false;
