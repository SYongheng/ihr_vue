  ...
  <div>
    <el-container class="home-container">
      <el-header class="home-header">
        <span class="home_title">i人事</span>
        <div style="display: flex;align-items: center;margin-right: 7px">
          ...
          <el-dropdown @command="handleCommand">
            ...
            <el-dropdown-menu slot="dropdown">
              <el-dropdown-item command="goCenter">个人中心</el-dropdown-item>
      ...
      <el-container>
        ...
        <el-main>
          ...
          <template v-if="this.$router.currentRoute.name === '主页'">
            <div>
              <h1>欢迎使用i人事,{{user.name}}</h1>
              <img src="../../static/img/welcome.jpg" style="width:80%; height:40%">
            </div>
          </template>
          <keep-alive>
