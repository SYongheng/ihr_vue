<template>
  <div style="margin-top: 10px" v-loading="fullloading">
    ...
    <div style="display: flex;justify-content: space-around;flex-wrap: wrap;text-align: left">
      ...
      <el-dialog title="新增操作员" :visible.sync="dialogFormVisible" @close="closeDialog">
        <el-form :model="addUserForm" ref="addUserFormRef" :rules="addUserFormRules">
          ...
          <el-form-item label="请确认：" prop="newPassword">
            <el-input type="password" v-model="addUserForm.newPassword"></el-input>
          </el-form-item>
        </el-form>
        <div slot="footer" class="dialog-footer">
          <el-button @click="dialogFormVisible = false">取 消</el-button>
          <el-button type="primary" @click="addHr()">确 定</el-button>
        </div>
      </el-dialog>
    </div>
  </div>
...
export default {
  ...
  methods: {
    ...
    addHr() {
      var _this = this;
      this.postRequest("/system/hr/register", {
    ...
    closeDialog() {
      this.addUserForm = { username: "", password: "", newPassword: "" };
    }
  }
};
</script>
